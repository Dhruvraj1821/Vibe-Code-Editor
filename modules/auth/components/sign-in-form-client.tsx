      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-zinc-900/80 backdrop-blur-sm border border-white/8 rounded-2xl p-8 shadow-2xl shadow-black/40">
          <div className="text-center mb-7">
            ...
            <p className="text-sm text-zinc-500">Sign in to your VibeCode account</p>
          </div>
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                <Button variant="link" className="px-0 h-auto text-xs text-violet-400 hover:text-violet-300">
                  Forgot password?
                </Button>
              </div>
        ...
        <p className="text-center text-sm text-zinc-600 mt-6">
          ...
          <Link href="/auth/sign-up" className="text-violet-400 hover:text-violet-300 transition-colors">
            Sign up
          </Link>
        </p>
      </div>
